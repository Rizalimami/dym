...
class dym_stock_production_lot_pengurusan_stnk_bpkb(osv.osv):
    _inherit = 'stock.production.lot'
    _columns = {
        'pengurusan_stnk_bpkb_id' : fields.many2one('dym.pengurusan.stnk.bpkb',string='Pengurusan STNK & BPKB'),
