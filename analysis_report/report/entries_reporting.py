...
class account_entries_report(osv.osv):
    ...
    _columns = {
        ...
        'analytic_account_id': fields.many2one('account.analytic.account', 'Analytic Cost Center', readonly=True),
        'analytic_1': fields.many2one('account.analytic.account', 'Analytic Company', readonly=True),
        'analytic_2': fields.many2one('account.analytic.account', 'Analytic Bisnis Unit', readonly=True),
        'analytic_3': fields.many2one('account.analytic.account', 'Analytic Branch', readonly=True),
        ...
        'journal_entries': fields.many2one('account.move', 'Journal Entry', readonly=True),
    }
    ...
    def init(self, cr):
        ...
        cr.execute("""
            ...
            select
                ...
                aa.analytic_1 as analytic_1,
                aa.analytic_2 as analytic_2,
                aa.analytic_3 as analytic_3,
