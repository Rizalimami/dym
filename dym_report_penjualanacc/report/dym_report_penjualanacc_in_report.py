...
class dym_report_penjualanacc_report(osv.osv):
    _name = "dym.report.penjualanacc.report"
    _description = "Report Penjualan Acc"
    _auto = False
    ...
    def init(self, cr):
        tools.sql.drop_view_if_exists(cr, 'dym_report_penjualanacc_report')
        cr.execute("""
            create or replace view dym_report_penjualanacc_report as (
