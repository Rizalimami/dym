...
class dym_net_off(models.Model):
    _name = 'dym.net.off'
    ...
    net_off_line = fields.One2many('dym.net.off.line','net_off_id',string='')
    ...
    def create(self,vals,context=None):
        ...
        vals['name'] = self.env['ir.sequence'].get_per_branch(vals['branch_id'], 'NO', division=False) 
        ...
        res = super(dym_net_off, self).create(vals)
    ...
    def write(self,values,context=None): 
        res = super(dym_net_off,self).write(values)
        cek = self.cek_total_amount()
        return res
    ...
    def unlink(self, cr, uid, ids, context=None):
        ...
        return super(dym_net_off, self).unlink(cr, uid, ids, context=context) 
                                
class dym_net_off_line(models.Model):
    _name = 'dym.net.off.line'
    ...
    net_off_id = fields.Many2one('dym.net.off',string='Net Off') 
