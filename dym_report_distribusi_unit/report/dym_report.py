...
class dym_report_distribusi_unit_print(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        if context is None:
            context = {}
        super(dym_report_distribusi_unit_print, self).__init__(
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        report_distribusi_unit = {
            'type': 'payable',
            'title': '',
            'title_short': title_short_prefix + ', ' + _('Laporan Distribusi Unit')}
        ...
        reports = [report_distribusi_unit]
            ...
            if all_lines:
                p_map = map(
                    lambda x: {
                        ...
                        'internal_reference': str(x['description']) if 'description' in x and x['description'] != None else str(x['internal_reference']) if 'internal_reference' in x and x['internal_reference'] != None else '',
        ...
        if not reports :
            reports = [{'title_short': 'Laporan Distribusi Unit', 
                        'detail_lines':[{
                            'no': '',
        ...
        objects=False
        super(dym_report_distribusi_unit_print, self).set_context(
    ...
    def formatLang_zero2blank(self, value, digits=None, date=False, date_time=False,
        ...
        if isinstance(value, (float, int)) and not value:
            ...
            return super(dym_report_distribusi_unit_print, self).formatLang(
                value, digits, date, date_time, grouping,
                monetary, dp, currency_obj)

class wrapped_vat_declaration_print(orm.AbstractModel):
    _name = 'report.dym_report_distribusi_unit.report_distribusi_unit'
    _inherit = 'report.abstract_report'
    _template = 'dym_report_distribusi_unit.report_distribusi_unit'
    _wrapped_report_class = dym_report_distribusi_unit_print
