...
from .dym_report_hutangbankdf import dym_report_hutangbankdf_print
...
class dym_report_hutangbankdf_print_xls(dym_report_hutangbankdf_print):

    def __init__(self, cr, uid, name, context):
        super(dym_report_hutangbankdf_print_xls, self).__init__(
            cr, uid, name, context=context)
        move_line_obj = self.pool.get('account.move.line')
        self.context = context
        wl_overview = move_line_obj._report_xls_hutangbankdf_fields(
            cr, uid, context)
        tmpl_upd_overview = move_line_obj._report_xls_arap_overview_template(
            cr, uid, context)
        wl_overview_detail_pembayaran = move_line_obj._report_xls_hutangbankdf_fields_detail_pembayaran(
            cr, uid, context)
...
class report_hutangbankdf_xls(report_xls):

    def __init__(self, name, table, rml=False,
                 parser=False, header=True, store=False):
        super(report_hutangbankdf_xls, self).__init__(
        ...
        self.col_specs_template_overview = {
            ...
            'branch_inv': {
                ...
                'lines': [1, 0, 'text', _render("p['branch_inv']")],
                'totals': [1, 22, 'text', None]},
            'inv_number': {
                'header': [1, 22, 'text', _render("_('No Invoicer')")],
            ...
            'bunga': {
                'header': [1, 22, 'text', _render("_('Bunga')")],
                'lines': [1, 0, 'number', _render("p['bunga']"), None, self.pd_cell_style_decimal],
                'totals': [1, 22, 'number', _render("p['bunga']"), None, self.rt_cell_style_decimal]},
...
#             row_pos_o += 2
            ...
            if r['detail_pembayaran'] == False:
                ws_o.write(row_pos_o, 15, xlwt.Formula("SUM(P" + str(row_data_begin) + ":P" + str(row_data_end) + ")"),
                ...
                ws_o.write(row_pos_o, 18, xlwt.Formula("SUM(S" + str(row_data_begin) + ":S" + str(row_data_end) + ")"),
                           self.rt_cell_style_decimal)
                ws_o.write(row_pos_o, 19, xlwt.Formula("SUM(T" + str(row_data_begin) + ":T" + str(row_data_end) + ")"),
                           self.rt_cell_style_decimal)
                ...
                ws_o.write(row_pos_o, 20, None, self.rt_cell_style_decimal)
                ws_o.write(row_pos_o, 21, xlwt.Formula("SUM(V" + str(row_data_begin) + ":V" + str(row_data_end) + ")"),
                           self.rt_cell_style_decimal)
                ws_o.write(row_pos_o, 22, xlwt.Formula("SUM(W" + str(row_data_begin) + ":W" + str(row_data_end) + ")"),
                           self.rt_cell_style_decimal)
                ws_o.write(row_pos_o, 23, xlwt.Formula("SUM(X" + str(row_data_begin) + ":X" + str(row_data_end) + ")"),
                           self.rt_cell_style_decimal)
                ws_o.write(row_pos_o, 24, xlwt.Formula("SUM(Y" + str(row_data_begin) + ":Y" + str(row_data_end) + ")"),
                           self.rt_cell_style_decimal)
                ws_o.write(row_pos_o, 25, None, self.rt_cell_style_decimal)
                ws_o.write(row_pos_o, 26, None, self.rt_cell_style_decimal)
                ws_o.write(row_pos_o, 27, None, self.rt_cell_style_decimal)
...
report_hutangbankdf_xls('report.Laporan Hutang Bank DF', 'account.move.line', parser = dym_report_hutangbankdf_print_xls)
