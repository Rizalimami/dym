        ...
        ***********************************************************************/
        ...
        _load_data: function(){
            ...
            this._fetch('res.users',['company_id'],[['id','=',this.session.uid]]).then(function(res_users){
                ...
                self.current_company_code = res_users[0].company_id[0];
                self.current_company_name = res_users[0].company_id[1];
                self.current_company_logo = self.session.url(
                    '/web/binary/image', {
                        model:'res.company', 
                        field: 'logo_topbar', 
                        id: res_users[0].company_id[0]
                    });                
                ...
                //       not work either..call('read',[locations_ids, []])
