...
report_sxw.report_sxw('report.rml.work.order.invoice', 'dym.work.order', 'addons/dym_work_order/report/dym_work_order_invoice_report.rml', parser = dym_work_order, header = False)