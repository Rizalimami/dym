...
class work_order_report(osv.osv):
    ...
    _columns = {
        ...
        'date': fields.datetime('Memo Date', readonly=True, help="Date on which this document has been created"),  # TDE FIXME master: rename into date_order
        'state': fields.selection([('draft', 'Request for Quotation'),
                                     ('confirmed', 'Waiting Supplier Ack'),
                                      ...
                                      ('done', 'Done'),
                                      ('cancel', 'Cancelled')],'Memo Status', readonly=True),
