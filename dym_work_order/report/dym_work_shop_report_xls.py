...
from .dym_work_shop_report import dym_work_order_report_print
...
class dym_work_order_print_xls(dym_work_order_report_print):

    def __init__(self, cr, uid, name, context):
        super(dym_work_order_print_xls, self).__init__(
            cr, uid, name, context=context)
        quant_obj = self.pool.get('dym.work.order')
...
stock_report_xls(
    'report.dym.work.shop.report.xls',
    'account.period',
    parser=dym_work_order_print_xls)
