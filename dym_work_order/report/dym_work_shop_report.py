...
class dym_work_order_report_print(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        if context is None:
            context = {}
        super(dym_work_order_report_print, self).__init__(
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        query_start = "select a.id as p_id, " \
                      ...
                      "from dym_work_order a  " \
                      "left join dym_work_order_line b ON a.id = b.work_order_id " \
                      "left join dym_branch c ON c.id = a.branch_id " \
        ...
        super(dym_work_order_report_print, self).set_context(
    ...
    def formatLang_zero2blank(self, value, digits=None, date=False, date_time=False,
        ...
        if isinstance(value, (float, int)) and not value:
            ...
            return super(dym_work_order_report_print, self).formatLang(
                value, digits, date, date_time, grouping,
                monetary, dp, currency_obj)

class wrapped_vat_declaration_print(orm.AbstractModel):
    _name = 'report.dym_work_order.report_work_order'
    _inherit = 'report.abstract_report'
    _template = 'dym_work_order.report_work_order'
    _wrapped_report_class = dym_work_order_report_print
