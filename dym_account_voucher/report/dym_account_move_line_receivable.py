...
class dym_account_receivable_report(osv.osv):
    _name = "dym.account.receivable.report"
    ...
    def init(self, cr):
        tools.drop_view_if_exists(cr, 'dym_account_receivable_report')
        cr.execute("""
            create or replace view dym_account_receivable_report as (
            select
                p.id as id,
            ...
            from
                ...
                left join dym_branch b on (d.branch_id=b.id)
