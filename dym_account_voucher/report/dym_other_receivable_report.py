...
report_sxw.report_sxw('report.rml.other.receivable', 'account.voucher', 'addons/account_voucher/report/dym_other_receivable_report.rml', parser = account_voucher, header = False)