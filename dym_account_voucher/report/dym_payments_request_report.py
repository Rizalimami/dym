...
report_sxw.report_sxw('report.rml.payments.request', 'account.voucher', 'addons/account_voucher/report/dym_payments_request_report.rml', parser = account_voucher, header = False)