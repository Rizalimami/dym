...
report_sxw.report_sxw('report.rml.supplier.payment', 'account.voucher', 'addons/account_voucher/report/dym_supplier_payment_report.rml', parser = account_voucher, header = False)