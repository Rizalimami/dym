...
class account_voucher_or(models.Model):
    ...
    def branch_id_onchange(self,branch_id):
        ...
        dict=self.env['dym.account.filter'].get_domain_account('other_receivable_header')
...
class account_voucher_line(models.Model):
    ...
    def account_id_onchange(self,account_id,branch_id,division):
        ...
        dict=self.env['dym.account.filter'].get_domain_account('other_receivable_detail')
