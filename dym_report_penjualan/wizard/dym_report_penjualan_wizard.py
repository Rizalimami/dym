...
class dym_report_penjualan_wizard(orm.TransientModel):
    _name = 'dym.report.penjualan.wizard'
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        ...
        res = super(dym_report_penjualan_wizard, self).fields_view_get(cr, uid, view_id=view_id, view_type=view_type, context=context, toolbar=toolbar, submenu=submenu)
    ...
    _columns = {
        ...
        'product_ids': fields.many2many('product.product', 'dym_report_penjualan_product_rel', 'dym_report_penjualan_wizard_id',
            'product_id', 'Products'),
        ...
        'branch_ids': fields.many2many('dym.branch', 'dym_report_penjualan_branch_rel', 'dym_report_penjualan_wizard_id',
            'branch_id', 'Branches', copy=False),
        'finco_ids': fields.many2many('res.partner', 'dym_report_penjualan_partner_rel', 'dym_report_penjualan_wizard_id',
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        if context.get('xls_export') == 'detail_per_chassis_engine' :
            ...
            return self.pool['report'].get_action(cr, uid, [], 'dym_report_penjualan.report_penjualan', data=data, context=context)
