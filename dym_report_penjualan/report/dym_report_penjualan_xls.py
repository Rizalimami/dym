...
from .dym_report_penjualan import dym_report_penjualan_print
from openerp.tools.translate import translate
import string

_ir_translation_name = 'report.penjualan'

class dym_report_penjualan_print_xls(dym_report_penjualan_print):

    def __init__(self, cr, uid, name, context):
        super(dym_report_penjualan_print_xls, self).__init__(cr, uid, name, context=context)
        dso_obj = self.pool.get('dealer.sale.order')
        self.context = context
        wl_overview = dso_obj._report_xls_penjualan_fields(cr, uid, context)
...
class report_penjualan_xls(report_xls):

    def __init__(self, name, table, rml=False, parser=False, header=True, store=False):
        super(report_penjualan_xls, self).__init__(name, table, rml, parser, header, store)
...
report_penjualan_xls(
    'report.Laporan Penjualan',
    'dealer.sale.order',
    parser = dym_report_penjualan_print_xls)
