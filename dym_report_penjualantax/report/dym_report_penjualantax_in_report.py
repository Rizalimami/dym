...
class dym_report_penjualantax_report(osv.osv):
    _name = "dym.report.penjualantax.report"
    _description = "Report Penjualan Tax"
    _auto = False
    ...
    def init(self, cr):
        tools.sql.drop_view_if_exists(cr, 'dym_report_penjualantax_report')
        cr.execute("""
            create or replace view dym_report_penjualantax_report as (
