...
class account_print_journal_xls(orm.TransientModel):
    ...
    _columns = {
        ...
        'branch_ids': fields.many2many(
            'dym.branch',
            'account_print_branch_xls_branch_rel',
            'branch_xls_id',
            'branch_id',
            string='Branches'),
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        wiz_branch_ids = [j.id for j in wiz_form.branch_ids]

        #print wiz_journal_ids ,'ccccccccccccc',wiz_branch_ids
        # sort journals
