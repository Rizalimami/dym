...
from .dym_report_piutang_pajak_progresif import dym_report_piutang_pajak_progresif_print
from openerp.tools.translate import translate
import logging
_logger = logging.getLogger(__name__)
import string

_ir_translation_name = 'report.piutang.pajak.progresif'

class dym_report_piutang_pajak_progresif_print_xls(dym_report_piutang_pajak_progresif_print):

    def __init__(self, cr, uid, name, context):
        super(dym_report_piutang_pajak_progresif_print_xls, self).__init__(
            cr, uid, name, context=context)
        move_line_obj = self.pool.get('account.move.line')
        self.context = context
        wl_overview = move_line_obj._report_xls_piutang_pajak_progresif_fields(
            cr, uid, context)
        wl_overview_detail_pembayaran = move_line_obj._report_xls_piutang_pajak_progresif_fields_detail_pembayaran(
            cr, uid, context)
...
class report_piutang_pajak_progresif_xls(report_xls):

    def __init__(self, name, table, rml=False,
                 parser=False, header=True, store=False):
        super(report_piutang_pajak_progresif_xls, self).__init__(
...
report_piutang_pajak_progresif_xls('report.Laporan Piutang Pajak Progresif', 'account.move.line', parser = dym_report_piutang_pajak_progresif_print_xls)
