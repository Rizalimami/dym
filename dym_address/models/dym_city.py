...
class dym_city(osv.osv):
    ...
    _columns = {
        ...
        'kecamatan_ids': fields.one2many('dym.kecamatan', 'city_id', string='Kecamatan', readonly=True),
    }
    _sql_constraints = [
       ('code_unique', 'unique(code,state_id)', 'Code City tidak boleh ada yang sama.'),  
    ]
