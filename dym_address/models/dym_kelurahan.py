...
class dym_kelurahan(osv.osv):
    ...
    _columns = {
        ...
        'kecamatan_id':fields.many2one('dym.kecamatan','Kecamatan',required=True),
        'city_id':fields.related('kecamatan_id','city_id',type='many2one', relation='dym.city', readonly=True, string='City', store=False),
    ...
    def name_search(self, cr, user, name='', args=None, operator='ilike',
        ...
        ids = []
        if len(name) < 6:
            ids = self.search(cr, user, ['|',('zip', 'ilike', name),('code', 'ilike', name)] + args,
