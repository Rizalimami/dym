...
class dym_report_kinerja_so_wizard(orm.TransientModel):
    _name = 'dym.report.kinerja.so.wizard'
    _description = 'Report Kinerja SO Wizard'
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        ...
        res = super(dym_report_kinerja_so_wizard, self).fields_view_get(cr, uid, view_id=view_id, view_type=view_type, context=context, toolbar=toolbar, submenu=submenu)
    ...
    _columns = {
        ...
        'product_ids': fields.many2many('product.product', 'dym_report_kinerja_so_product_rel', 'dym_report_kinerja_so_wizard_id',
            'product_id', 'Products'),
        ...
        'branch_ids': fields.many2many('dym.branch', 'dym_report_kinerja_so_branch_rel', 'dym_report_kinerja_so_wizard_id',
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        if context.get('xls_export') :
            return {'type': 'ir.actions.report.xml',
                    'report_name': 'Laporan Kinerja SO',
                    'datas': data}
        else :
            context['landscape'] = True
            return self.pool['report'].get_action(cr, uid, [], 'dym_report_kinerja_so.report_kinerja_so', data=data, context=context)
