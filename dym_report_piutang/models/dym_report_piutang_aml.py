...
class dym_report_piutang_account_move_line(models.Model):
    _inherit = 'account.move.line'

    
    # override list in custom module to add/drop columns
    # or change order of the partner summary table
    def _report_xls_piutang_fields(self, cr, uid, context=None):
        return [
            'no',\
            'branch_status',\
            'branch_name',\
    ...
    def _report_xls_piutang_fields_detail_pembayaran(self, cr,uid, context=None):
        return [
            'no',\
            'branch_status',\
            'branch_name',\
