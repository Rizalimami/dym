...
from .dym_report_stock_mutation import dym_report_stock_mutation_print
from openerp.tools.translate import translate
import string

_ir_translation_name = 'report.stock.mutation'

class dym_report_stock_mutation_print_xls(dym_report_stock_mutation_print):

    def __init__(self, cr, uid, name, context):
        super(dym_report_stock_mutation_print_xls, self).__init__(cr, uid, name, context=context)
        move_obj = self.pool.get('stock.move')
        self.context = context
        wl_overview = move_obj._report_xls_stock_mutation_fields(cr, uid, context)
        wl_overview_sparepart = move_obj._report_xls_stock_mutation_fields_sparepart(cr,uid, context)
...
class report_stock_mutation_xls(report_xls):

    def __init__(self, name, table, rml=False, parser=False, header=True, store=False):
        super(report_stock_mutation_xls, self).__init__(name, table, rml, parser, header, store)
        ...
        self.col_specs_template_overview = {
            ...
            'picking_type_name': {
                ...
                'totals': [1, 22, 'text', None]},
            'packing_name': {
                'header': [1, 22, 'text', _render("_('Dokumen Movement')")],
            ...
            'chassis': {
                ...
                'totals': [1, 22, 'text', None]},
            'qty': {
                'header': [1, 22, 'text', _render("_('Qty Pembelian')")],
            ...
            'qty_out': {
                'header': [1, 22, 'text', _render("_('Qty Penjualan')")],
            ...
            'qty_retur_beli': {
                'header': [1, 22, 'text', _render("_('Qty Retur Pembelian')")],
                'lines': [1, 0, 'number', _render("p['qty_retur_beli']"), None, self.pd_cell_style_decimal],
                'totals': [1, 22, 'number', _render("p['qty_retur_beli']"), None, self.rt_cell_style_decimal]},
            'qty_retur_jual': {
                'header': [1, 22, 'text', _render("_('Qty Retur Penjualan')")],
                'lines': [1, 0, 'number', _render("p['qty_retur_jual']"), None, self.pd_cell_style_decimal],
                'totals': [1, 22, 'number', _render("p['qty_retur_jual']"), None, self.rt_cell_style_decimal]},
            'qty_adjustment_in': {
                'header': [1, 22, 'text', _render("_('Qty Adjustment In')")],
                'lines': [1, 0, 'number', _render("p['qty_adjustment_in']"), None, self.pd_cell_style_decimal],
                'totals': [1, 22, 'number', _render("p['qty_adjustment_in']"), None, self.rt_cell_style_decimal]},
            'qty_adjustment_out': {
                'header': [1, 22, 'text', _render("_('Qty Adjustment Out')")],
                'lines': [1, 0, 'number', _render("p['qty_adjustment_out']"), None, self.pd_cell_style_decimal],
                'totals': [1, 22, 'number', _render("p['qty_adjustment_out']"), None, self.rt_cell_style_decimal]},
            'qty_awal': {
                'header': [1, 22, 'text', _render("_('Qty Saldo Awal')")],
                'lines': [1, 0, 'number', _render("p['qty_awal']"), None, self.pd_cell_style_decimal],
                'totals': [1, 22, 'number', _render("p['qty_awal']"), None, self.rt_cell_style_decimal]},
            'qty_akhir': {
                'header': [1, 22, 'text', _render("_('Qty Saldo Akhir')")],
                'lines': [1, 0, 'number', _render("p['qty_akhir']"), None, self.pd_cell_style_decimal],
                'totals': [1, 22, 'number', _render("p['qty_akhir']"), None, self.rt_cell_style_decimal]},
            'amount': {
                'header': [1, 22, 'text', _render("_('Amount Pembelian')")],
                'lines': [1, 0, 'number', _render("p['amount']"), None, self.pd_cell_style_decimal],
                'totals': [1, 22, 'number', _render("p['amount']"), None, self.rt_cell_style_decimal]},
            'amount_out': {
                'header': [1, 22, 'text', _render("_('Amount Penjualan')")],
                'lines': [1, 0, 'number', _render("p['amount_out']"), None, self.pd_cell_style_decimal],
                'totals': [1, 22, 'number', _render("p['amount_out']"), None, self.rt_cell_style_decimal]},
            'amount_retur_beli': {
                'header': [1, 22, 'text', _render("_('Amount Retur Pembelian')")],
                'lines': [1, 0, 'number', _render("p['amount_retur_beli']"), None, self.pd_cell_style_decimal],
                'totals': [1, 22, 'number', _render("p['amount_retur_beli']"), None, self.rt_cell_style_decimal]},
            'amount_retur_jual': {
                'header': [1, 22, 'text', _render("_('Amount Retur Penjualan')")],
                'lines': [1, 0, 'number', _render("p['amount_retur_jual']"), None, self.pd_cell_style_decimal],
                'totals': [1, 22, 'number', _render("p['amount_retur_jual']"), None, self.rt_cell_style_decimal]},
            'amount_adjustment_in': {
                'header': [1, 22, 'text', _render("_('Amount Adjustment In')")],
                'lines': [1, 0, 'number', _render("p['amount_adjustment_in']"), None, self.pd_cell_style_decimal],
                'totals': [1, 22, 'number', _render("p['amount_adjustment_in']"), None, self.rt_cell_style_decimal]},
            'amount_adjustment_out': {
                'header': [1, 22, 'text', _render("_('Amount Adjustment Out')")],
                'lines': [1, 0, 'number', _render("p['amount_adjustment_out']"), None, self.pd_cell_style_decimal],
                'totals': [1, 22, 'number', _render("p['amount_adjustment_out']"), None, self.rt_cell_style_decimal]},
            'amount_awal': {
                'header': [1, 22, 'text', _render("_('Amount Saldo Awal')")],
                'lines': [1, 0, 'number', _render("p['amount_awal']"), None, self.pd_cell_style_decimal],
                'totals': [1, 22, 'number', _render("p['amount_awal']"), None, self.rt_cell_style_decimal]},
            'amount_akhir': {
                'header': [1, 22, 'text', _render("_('Amount Saldo Akhir')")],
                'lines': [1, 0, 'number', _render("p['amount_akhir']"), None, self.pd_cell_style_decimal],
                'totals': [1, 22, 'number', _render("p['amount_akhir']"), None, self.rt_cell_style_decimal]},
            'location': {
    ...
    def generate_xls_report(self, _p, _xs, data, objects, wb):
        ...
        for r in _p.reports:
            ...
            c_specs_o = [
                ('report_name', 1, 0, 'text', 'LAPORAN Stock Mutation ' + division),
            ]
            row_data = self.xls_row_template(c_specs_o, ['report_name'])
            row_pos_o = self.xls_write_row(
                ws_o, row_pos_o, row_data, row_style=cell_style)
            ...
            if division == 'Sparepart':   
                ...
                row_pos_o += 1
                ws_o.write(row_pos_o, 1, "Date", self.ph_cell_style)
                ws_o.write(row_pos_o, 2, ('-' if data['date_start_date'] == False else str(data['date_start_date'])) + ' s/d ' + ('-' if data['date_end_date'] == False else str(data['date_end_date'])), self.ph_cell_style)    
                row_pos_o += 1
            elif division == 'Unit':
                ws_o.write(row_pos_o, 1, "Cabang", self.ph_cell_style)
                ws_o.write(row_pos_o, 2, r['cabang'], self.ph_cell_style)    
...
report_stock_mutation_xls(
    'report.Laporan Stock Mutation',
    'stock.move',
    parser = dym_report_stock_mutation_print_xls)
