...
report_sxw.report_sxw('report.rml.purchase.order', 'purchase.order', 'addons/dym_purchase_order/report/dym_purchase_order_report.rml', parser = purchase_order, header = False)