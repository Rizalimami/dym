...
class dym_report_rjualacc_print(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        if context is None:
            context = {}
        super(dym_report_rjualacc_print, self).__init__(cr, uid, name, context=context)
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        query_rjualacc = """
            select  distinct dso.id as id_dso, 
                dsol.id as id_dsol, 
                ...
                */
                COALESCE(dsol_disc.ps_dealer,0) - COALESCE(dsol_disc_not.ps_dealer,0) as ps_dealer, 
                COALESCE(dsol_disc.ps_ahm,0) - COALESCE(dsol_disc_not.ps_ahm,0) as ps_ahm, 
                COALESCE(dsol_disc.ps_md,0) - COALESCE(dsol_disc_not.ps_md,0) as ps_md, 
                --COALESCE(dsol_disc.ps_finco,0) as ps_finco,
                COALESCE(dsol_disc.ps_finco_test,0) - COALESCE(dsol_disc_not.ps_finco_test,0) as ps_finco,
                (COALESCE(dsol_disc.ps_dealer,0)+COALESCE(dsol_disc.ps_ahm,0)+COALESCE(dsol_disc.ps_md,0)+COALESCE(dsol_disc.ps_finco,0)) - (COALESCE(dsol_disc_not.ps_dealer,0)+COALESCE(dsol_disc_not.ps_ahm,0)+COALESCE(dsol_disc_not.ps_md,0)+COALESCE(dsol_disc_not.ps_finco,0)) as ps_total, 

                case when dbc.free_tax in ('t') then COALESCE(dsol.price_unit,0) else COALESCE(dsol.price_unit/1.1,0) end as sales, 
                COALESCE(dsol_disc_not.discount_pelanggan,0) as disc_quo_incl_tax_no, 
                COALESCE(dsol_disc_yes.discount_pelanggan,0) as disc_quo_incl_tax, 
                case when dbc.free_tax in ('t') then COALESCE(dsol.discount_po,0) else COALESCE(dsol.discount_po/1.1,0) end as disc_reg, 
                
                /*
                case when dbc.free_tax in ('t') then round(COALESCE(dsol_disc.ps_dealer,0)) else round(COALESCE(dsol_disc.ps_dealer,0)/1.1) end as ps_dealer_real, 
                case when dbc.free_tax in ('t') then round(COALESCE(dsol_disc.ps_ahm,0)) else round(COALESCE(dsol_disc.ps_ahm,0)/1.1) end as ps_ahm_real, 
                case when dbc.free_tax in ('t') then round(COALESCE(dsol_disc.ps_md,0)) else round(COALESCE(dsol_disc.ps_md,0)/1.1) end as ps_md_real, 
                --round(COALESCE(dsol_disc.ps_finco_real,0)/1.1) as ps_finco_real, 
                case when dbc.free_tax in ('t') then round(COALESCE(dsol_disc.ps_finco_test,0)) else round(COALESCE(dsol_disc.ps_finco_test,0)/1.1) end as ps_finco_real, 
                case when dbc.free_tax in ('t') then round((COALESCE(dsol_disc.ps_dealer,0)+COALESCE(dsol_disc.ps_ahm,0)+COALESCE(dsol_disc.ps_md,0)+COALESCE(dsol_disc.ps_finco_real,0))) else round((COALESCE(dsol_disc.ps_dealer,0)+COALESCE(dsol_disc.ps_ahm,0)+COALESCE(dsol_disc.ps_md,0)+COALESCE(dsol_disc.ps_finco_real,0))/1.1) end as ps_total_real, 
                */
                case when dbc.free_tax in ('t') then round((COALESCE(dsol_disc.ps_dealer,0)-COALESCE(dsol_disc_not.ps_dealer,0))) else round((COALESCE(dsol_disc.ps_dealer,0)-COALESCE(dsol_disc_not.ps_dealer,0))/1.1) end as ps_dealer_real, 
                case when dbc.free_tax in ('t') then round((COALESCE(dsol_disc.ps_ahm,0)-COALESCE(dsol_disc_not.ps_ahm,0))) else round((COALESCE(dsol_disc.ps_ahm,0)-COALESCE(dsol_disc_not.ps_ahm,0))/1.1) end as ps_ahm_real, 
                case when dbc.free_tax in ('t') then round((COALESCE(dsol_disc.ps_md,0)-COALESCE(dsol_disc_not.ps_md,0))) else round((COALESCE(dsol_disc.ps_md,0)-COALESCE(dsol_disc_not.ps_md,0))/1.1) end as ps_md_real, 
                --round(COALESCE(dsol_disc.ps_finco_real,0)/1.1) as ps_finco_real, 
                case when dbc.free_tax in ('t') then round((COALESCE(dsol_disc.ps_finco_test,0)-COALESCE(dsol_disc_not.ps_finco,0))) else round((COALESCE(dsol_disc.ps_finco_test,0)-COALESCE(dsol_disc_not.ps_finco,0))/1.1) end as ps_finco_real, 
                case when dbc.free_tax in ('t') then round((COALESCE(dsol_disc.ps_dealer,0)+COALESCE(dsol_disc.ps_ahm,0)+COALESCE(dsol_disc.ps_md,0)+COALESCE(dsol_disc.ps_finco,0))) - round((COALESCE(dsol_disc_not.ps_dealer,0)+COALESCE(dsol_disc_not.ps_ahm,0)+COALESCE(dsol_disc_not.ps_md,0)+COALESCE(dsol_disc_not.ps_finco,0))) else round((COALESCE(dsol_disc.ps_dealer,0)+COALESCE(dsol_disc.ps_ahm,0)+COALESCE(dsol_disc.ps_md,0)+COALESCE(dsol_disc.ps_finco,0))/1.1) - round((COALESCE(dsol_disc_not.ps_dealer,0)+COALESCE(dsol_disc_not.ps_ahm,0)+COALESCE(dsol_disc_not.ps_md,0)+COALESCE(dsol_disc_not.ps_finco,0))/1.1) end as ps_total_real, 

                case when dbc.free_tax in ('t') then COALESCE(dsol_disc_yes.discount_pelanggan,0) else COALESCE(dsol_disc_yes.discount_pelanggan/1.1,0) end as disc_quo, 
                case when dbc.free_tax in ('t') then COALESCE(dsol.discount_po,0)+COALESCE(dsol_disc.discount_pelanggan,0) else COALESCE(dsol.discount_po/1.1,0)+COALESCE(dsol_disc.discount_pelanggan/1.1,0) end as disc_total, 
                COALESCE(dsol.price_subtotal,0) as price_subtotal, 
                case when dbc.free_tax in ('t') then 0 else round(dsol.price_subtotal*0.1,2) end as PPN, 
                ...
                case when dbc.free_tax in ('t') then COALESCE(dsol.discount_po,0)+COALESCE(dsol_disc.ps_dealer,0)+COALESCE(amount_hutang_komisi,0) else COALESCE(dsol.discount_po/1.1,0)+COALESCE(dsol_disc.ps_dealer/1.1,0)+COALESCE(amount_hutang_komisi,0) end as beban_cabang,
                ...
                --round(COALESCE(dsol_disc.ps_dealer,0)) as ps_dealer,
                --round(COALESCE(dsol_disc.ps_dealer,0)/1.1) as ps_dealer_real,
                /*dsol_disc_yes.include_invoice as include_yes,
                dsol_disc_not.include_invoice as include_not,
                COALESCE(dsol_disc_yes.ps_dealer,0) as "PS Dealer Yes(Juklak)", 
                COALESCE(dsol_disc_yes.ps_ahm,0) as "PS AHM Yes(Juklak)", 
                COALESCE(dsol_disc_yes.ps_md,0) as "PS MD Yes(Juklak)", 
                --COALESCE(dsol_disc.ps_finco,0) as ps_finco,
                COALESCE(dsol_disc_yes.ps_finco_test,0) as "PS Finco Yes(Juklak)",
                COALESCE(dsol_disc_yes.ps_dealer,0)+COALESCE(dsol_disc_yes.ps_ahm,0)+COALESCE(dsol_disc_yes.ps_md,0)+COALESCE(dsol_disc_yes.ps_finco,0) as "PS Total Yes(Juklak)", 
                COALESCE(dsol_disc_not.ps_dealer,0) as "PS Dealer No(Juklak)", 
                COALESCE(dsol_disc_not.ps_ahm,0) as "PS AHM No(Juklak)", 
                COALESCE(dsol_disc_not.ps_md,0) as "PS MD No(Juklak)", 
                --COALESCE(dsol_disc.ps_finco,0) as ps_finco,
                COALESCE(dsol_disc_not.ps_finco_test,0) as "PS Finco No(Juklak)",
                COALESCE(dsol_disc_not.ps_dealer,0)+COALESCE(dsol_disc_not.ps_ahm,0)+COALESCE(dsol_disc_not.ps_md,0)+COALESCE(dsol_disc_not.ps_finco,0) as "PS Total No(Juklak)", */
                COALESCE(dsol_disc.ps_dealer,0) - COALESCE(dsol_disc_not.ps_dealer,0) as "PS Dealer (Juklak)", 
                COALESCE(dsol_disc.ps_ahm,0) - COALESCE(dsol_disc_not.ps_ahm,0) as "PS AHM (Juklak)", 
                COALESCE(dsol_disc.ps_md,0) - COALESCE(dsol_disc_not.ps_md,0) as "PS MD (Juklak)", 
                --COALESCE(dsol_disc.ps_finco,0) as ps_finco,
                COALESCE(dsol_disc.ps_finco_test,0) - COALESCE(dsol_disc_not.ps_finco_test,0) as "PS Finco (Juklak)",
                (COALESCE(dsol_disc.ps_dealer,0)+COALESCE(dsol_disc.ps_ahm,0)+COALESCE(dsol_disc.ps_md,0)+COALESCE(dsol_disc.ps_finco,0)) - (COALESCE(dsol_disc_not.ps_dealer,0)+COALESCE(dsol_disc_not.ps_ahm,0)+COALESCE(dsol_disc_not.ps_md,0)+COALESCE(dsol_disc_not.ps_finco,0)) as "PS Total (Juklak)", 
                round((COALESCE(dsol_disc.ps_dealer,0)-COALESCE(dsol_disc_not.ps_dealer,0))/1.1) as "DPP PS Dealer (Real)", 
                round((COALESCE(dsol_disc.ps_ahm,0)-COALESCE(dsol_disc_not.ps_ahm,0))/1.1) as "DPP PS AHM (Real)", 
                round((COALESCE(dsol_disc.ps_md,0)-COALESCE(dsol_disc_not.ps_md,0))/1.1) as "DPP PS MD (Real)", 
                --round(COALESCE(dsol_disc.ps_finco_real,0)/1.1) as ps_finco_real, 
                round((COALESCE(dsol_disc.ps_finco_test,0)-COALESCE(dsol_disc_not.ps_finco,0))/1.1) as "DPP PS Finco (Real)", 
                round((COALESCE(dsol_disc.ps_dealer,0)+COALESCE(dsol_disc.ps_ahm,0)+COALESCE(dsol_disc.ps_md,0)+COALESCE(dsol_disc.ps_finco,0))/1.1) - round((COALESCE(dsol_disc_not.ps_dealer,0)+COALESCE(dsol_disc_not.ps_ahm,0)+COALESCE(dsol_disc_not.ps_md,0)+COALESCE(dsol_disc_not.ps_finco,0))/1.1) as "DPP PS Total (Real)", 
                --COALESCE(dsol_disc_yes.discount_pelanggan) as "yes",
                --COALESCE(dsol_disc_not.discount_pelanggan) as "not",
                --COALESCE(dsol_disc.discount_pelanggan) as "nnyy",
                --round((COALESCE(dsol_disc.ps_dealer,0)+COALESCE(dsol_disc.ps_ahm,0)+COALESCE(dsol_disc.ps_md,0)+COALESCE(dsol_disc.ps_finco,0))/1.1) as "DPP PS Total (Real)", 
                --round((COALESCE(dsol_disc_not.ps_dealer,0)+COALESCE(dsol_disc_not.ps_ahm,0)+COALESCE(dsol_disc_not.ps_md,0)+COALESCE(dsol_disc_not.ps_finco,0))/1.1) as "DPP PS Total (Realasdadsasdasds)", 
                --round((COALESCE(dsol_disc.ps_dealer,0)+COALESCE(dsol_disc.ps_ahm,0)+COALESCE(dsol_disc.ps_md,0)+COALESCE(dsol_disc.ps_finco_real,0))/1.1) as "DPP PS Total (Real)", 
                */
                '' as a
            ...
            left join dym_branch_config dbc ON dbc.branch_id = b.id
            ...
            left join ( select dealer_sale_order_line_discount_line_id, include_invoice, sum(ps_finco) as ps_finco, case when sum(ps_finco) = sum(discount_pelanggan) then sum(ps_finco) 
                else case when sum(ps_finco) = 0 then sum(ps_finco) else sum(discount_pelanggan) - sum(ps_ahm) - sum(ps_md) - sum(ps_dealer) - sum(ps_others) end end as ps_finco_test, case when sum(ps_finco) = sum(discount_pelanggan) then sum(ps_finco) else case when sum(ps_finco) = 0 then sum(ps_finco) else sum(discount_pelanggan) end end as ps_finco_real, sum(ps_ahm) as ps_ahm, sum(ps_md) as ps_md, sum(ps_dealer) as ps_dealer, 
                sum(ps_others) as ps_others, case when sum(ps_finco) = sum(discount_pelanggan) then sum(ps_finco) else sum(discount_pelanggan) end as discount_real, sum(discount) as discount, sum(discount_pelanggan) as discount_pelanggan 
                from dealer_sale_order_line_discount_line where include_invoice = 'f'
                group by dealer_sale_order_line_discount_line_id,include_invoice ) dsol_disc_not ON dsol_disc_not.dealer_sale_order_line_discount_line_id = dsol.id 
            left join ( select dealer_sale_order_line_discount_line_id, include_invoice, sum(ps_finco) as ps_finco, case when sum(ps_finco) = sum(discount_pelanggan) then sum(ps_finco) 
                else case when sum(ps_finco) = 0 then sum(ps_finco) else sum(discount_pelanggan) - sum(ps_ahm) - sum(ps_md) - sum(ps_dealer) - sum(ps_others) end end as ps_finco_test, case when sum(ps_finco) = sum(discount_pelanggan) then sum(ps_finco) else case when sum(ps_finco) = 0 then sum(ps_finco) else sum(discount_pelanggan) end end as ps_finco_real, sum(ps_ahm) as ps_ahm, sum(ps_md) as ps_md, sum(ps_dealer) as ps_dealer, 
                sum(ps_others) as ps_others, case when sum(ps_finco) = sum(discount_pelanggan) then sum(ps_finco) else sum(discount_pelanggan) end as discount_real, sum(discount) as discount, sum(discount_pelanggan) as discount_pelanggan 
                from dealer_sale_order_line_discount_line where include_invoice = 't' 
            group by dealer_sale_order_line_discount_line_id, include_invoice ) dsol_disc_yes ON dsol_disc_yes.dealer_sale_order_line_discount_line_id = dsol.id 
        ...
        query_group = """   group by dso.id, drsl.name, dsol.price_subtotal, dsol.price_bbn, b.branch_status, b.code, spk.name, dcp.name, b.name, md.default_code, finco.name, employee_koord.name_related,
                        ...
                        """
        query_order = " order by 8,5"

        self.cr.execute(query_rjualacc + query_where + query_order)
        # raise osv.except_osv(('Perhatian !'), ("No \'%s\' ...")%(query_rjualacc + query_where + query_group + query_order))
        ...
        super(dym_report_rjualacc_print, self).set_context(objects, data, ids, report_type)
    ...
    def formatLang_zero2blank(self, value, digits=None, date=False, date_time=False, grouping=True, monetary=False, dp=False, currency_obj=False):
        if isinstance(value, (float, int)) and not value:
            ...
            return super(dym_report_rjualacc_print, self).formatLang(value, digits, date, date_time, grouping, monetary, dp, currency_obj)

class wrapped_vat_declaration_print(orm.AbstractModel):
    _name = 'report.dym_report_rjualacc.report_rjualacc'
    _inherit = 'report.abstract_report'
    _template = 'dym_report_rjualacc.report_rjualacc'
    _wrapped_report_class = dym_report_rjualacc_print
