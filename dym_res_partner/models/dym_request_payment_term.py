...
class dym_request_payment_term(models.Model):
    _name = 'dym.request.payment.term'
...
#         return True
    ...
    def create(self,vals,context=None):
        vals['name'] = self.env['ir.sequence'].get_per_branch(vals['branch_id'], 'RPT', division=vals['division'])   
        vals['date'] = datetime.today()                            
        return super(dym_request_payment_term, self).create(vals)
