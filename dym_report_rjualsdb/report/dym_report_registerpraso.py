...
class dym_report_registerpraso_print(report_sxw.rml_parse):
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        self.cr.execute(query_registerpraso + query_where + query_group + query_order)
        # raise osv.except_osv(('Perhatian !'), ("No \'%s\' ...")%(query_registerpraso + query_where + query_group + query_order))
