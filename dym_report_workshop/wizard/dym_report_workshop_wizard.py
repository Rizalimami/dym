...
class dym_report_workshop_wizard(orm.TransientModel):
    _name = 'dym.report.workshop.wizard'
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        if not context:
            context = {}
        res = super(dym_report_workshop_wizard, self).fields_view_get(cr, uid, view_id=view_id, view_type=view_type, context=context, toolbar=toolbar, submenu=submenu)
    ...
    _columns = {
        ...
        'wo_categ': fields.selection([('Sparepart','Workshop'),('Service','Service')], 'Workshop Category'),
        ...
        'product_ids': fields.many2many('product.product', 'dym_report_workshop_product_rel', 'dym_report_workshop_wizard_id',
            'product_id', 'Products'),
        'branch_ids': fields.many2many('dym.branch', 'dym_report_workshop_branch_rel', 'dym_report_workshop_wizard_id',
            'branch_id', 'Branches', copy=False),
        'partner_ids': fields.many2many('res.partner', 'dym_report_workshop_partner_rel', 'dym_report_workshop_wizard_id',
