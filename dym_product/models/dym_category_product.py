...
class dym_category_product(models.Model):
    _name = 'dym.category.product'
...
class dym_category_product_service(models.Model):
    _name = 'dym.category.product.service'
    _description = 'Category Product Service'
    _rec_name = 'category_product_id'
    
    category_product_id = fields.Many2one('dym.category.product', 'Category Service')
