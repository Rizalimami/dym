...
class dym_report_penjualandwh_report(osv.osv):
    _name = "dym.report.penjualandwh.report"
    _description = "Report Penjualan DWH"
    _auto = False
    ...
    def init(self, cr):
        tools.sql.drop_view_if_exists(cr, 'dym_report_penjualandwh_report')
        cr.execute("""
            create or replace view dym_report_penjualandwh_report as (
