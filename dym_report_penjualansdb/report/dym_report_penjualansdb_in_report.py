...
class dym_report_penjualansdb_report(osv.osv):
    _name = "dym.report.penjualansdb.report"
    _description = "Report Penjualan SDB"
    _auto = False
    ...
    def init(self, cr):
        tools.sql.drop_view_if_exists(cr, 'dym_report_penjualansdb_report')
        cr.execute("""
            create or replace view dym_report_penjualansdb_report as (
