...
from .dealer_sale_order_report import dym_dealer_sale_order_report_print
...
class dym_dealer_sale_order_print_xls(dym_dealer_sale_order_report_print):

    def __init__(self, cr, uid, name, context):
        super(dym_dealer_sale_order_print_xls, self).__init__(
    ...
    def __init__(self, name, table, rml=False,
        ...
        self.col_specs_template_overview = {
            ...
            'finco': {
                ...
                'totals': [1, 0, 'text', None]},
            'dp_net': {
                'header': [1, 22, 'text', _render("_('JP Net')")],
            ...
            'nama_stnk': {
                ...
                'totals': [1, 0, 'text', None]},
            'uang_muka': {
                'header': [1, 22, 'text', _render("_('Jaminan Pembelian')")],
...
stock_report_xls(
    ...
    'account.period',
    parser=dym_dealer_sale_order_print_xls)
