...
class dym_dealer_sale_order_report_print(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        if context is None:
            context = {}
        super(dym_dealer_sale_order_report_print, self).__init__(
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        objects = False
        super(dym_dealer_sale_order_report_print, self).set_context(
    ...
    def formatLang_zero2blank(self, value, digits=None, date=False, date_time=False,
        ...
        if isinstance(value, (float, int)) and not value:
            ...
            return super(dym_dealer_sale_order_report_print, self).formatLang(
...
class wrapped_vat_declaration_print(orm.AbstractModel):
    ...
    _wrapped_report_class = dym_dealer_sale_order_report_print
