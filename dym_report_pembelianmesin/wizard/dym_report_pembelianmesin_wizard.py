...
class dym_report_pembelianmesin_wizard(orm.TransientModel):
    _name = 'dym.report.pembelianmesin.wizard'
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        if not context:
            context = {}
        res = super(dym_report_pembelianmesin_wizard, self).fields_view_get(cr, uid, view_id=view_id, view_type=view_type, context=context, toolbar=toolbar, submenu=submenu)
    ...
    _columns = {
        ...
        'product_ids': fields.many2many('product.product', 'dym_report_pembelianmesin_product_rel', 'dym_report_pembelianmesin_wizard_id',
            'product_id', 'Products'),
        'branch_ids': fields.many2many('dym.branch', 'dym_report_pembelianmesin_branch_rel', 'dym_report_pembelianmesin_wizard_id',
            'branch_id', 'Branches', copy=False),
        'partner_ids': fields.many2many('res.partner', 'dym_report_pembelianmesin_partner_rel', 'dym_report_pembelianmesin_wizard_id',
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        return {'type': 'ir.actions.report.xml', 'report_name': 'Laporan Pembelian by No Mesin', 'datas': data}
