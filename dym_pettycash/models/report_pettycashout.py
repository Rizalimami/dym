...
from openerp.addons.dealer_sale_order.report.fungsi_terbilang import terbilang

class PettyCashOut(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(PettyCashOut, self).__init__(cr, uid, name, context=context)
        ids = context.get('active_ids')
        pettycash_obj = self.pool['dym.pettycash']
        docs = pettycash_obj.browse(cr, uid, ids, context)
...
class report_pettycashout(osv.AbstractModel):
    _name = 'report.dym_pettycash.report_pettycashout'
    _inherit = 'report.abstract_report'
    _template = 'dym_pettycash.report_pettycashout'
    _wrapped_report_class = PettyCashOut
