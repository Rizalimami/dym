...
class dym_stock_production_lot_proses_stnk(osv.osv):
    ...
    _columns = {
        ...
        'penerimaan_stnk_id' : fields.many2one('dym.penerimaan.stnk', string="No Penerimaan STNK"),
        'penerimaan_stnk_line_id' : fields.many2one('dym.penerimaan.stnk.line', string="No Baris Penerimaan STNK"),
        'tgl_terima_stnk' : fields.date('Tgl Terima STNK'),
        'proses_biro_jasa_id' : fields.many2one('dym.proses.birojasa',string="No Proses Biro Jasa"),
        ...
        'penerimaan_notice_id' : fields.many2one('dym.penerimaan.stnk', string="No Penerimaan Notice"),
        'tgl_terima_notice' : fields.date('Tgl Terima Notice'),
        'penerimaan_no_polisi_id' : fields.many2one('dym.penerimaan.stnk', string="No Penerimaan No Polisi"),
        'tgl_terima_no_polisi' : fields.date(' Tgl Terima No Polisi'),
        'penerimaan_bpkb_id' : fields.many2one('dym.penerimaan.bpkb', string="No Penerimaan BPKB"),
        'tgl_terima_bpkb' : fields.date('Tgl Terima BPKB'),
        'lokasi_bpkb_id' : fields.many2one('dym.lokasi.bpkb',string='Lokasi BPKB'),
        'no_urut_bpkb' : fields.char('No Urut'),
        'exclude_proses_birojasa' : fields.boolean('Exclude Proses Birojasa'),
        'lokasi_stnk_id' : fields.many2one('dym.lokasi.stnk',string='Lokasi STNK'),
