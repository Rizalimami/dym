...
class dym_lokasi_stnk(osv.osv):
    _name = "dym.lokasi.stnk"
    ...
    _columns = {
                ...
                'city_id' : fields.many2one('dym.city', 'Kota'),
    ...
    def unlink(self, cr, uid, ids, context=None):
        ...
        return super(dym_lokasi_stnk, self).unlink(cr, uid, ids, context=context)