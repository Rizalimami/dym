...
from .dym_report_trial_balance_import_sun import dym_trial_balance_import_sun_report_print
...
class dym_trial_balance_import_sun_print_xls(dym_trial_balance_import_sun_report_print):

    def __init__(self, cr, uid, name, context):
        super(dym_trial_balance_import_sun_print_xls, self).__init__(
...
class trial_balance_import_sun_report_xls(report_xls):
    ...
    def generate_xls_report(self, _p, _xs, data, objects, wb):
        ...
        for r in _p.reports:
            ...
            ws_o.write(row_pos_o, 13, "Total",self.ph_cell_style) 
            ...
            ws_o.write(row_pos_o, 18, xlwt.Formula("SUM(R"+str(row_data_begin)+":R"+str(row_data_end)+")"),self.pd_cell_style_decimal_fill)            
            ws_o.write(row_pos_o, 19, xlwt.Formula("SUM(S"+str(row_data_begin)+":S"+str(row_data_end)+")"),self.pd_cell_style_decimal_fill)            
            ws_o.write(row_pos_o+1, 0, _p.report_date+" "+username)



trial_balance_import_sun_report_xls(
    'report.dym_report_trial_balance_import_sun_xls',
    'account.move.line',
    parser=dym_trial_balance_import_sun_print_xls)
