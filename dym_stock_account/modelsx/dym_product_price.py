...
class dym_product_price_branch(osv.osv):
    ...
    def create(self, cr, uid, vals, context=None):
        super(dym_product_price_branch, self).create(cr, uid, vals, context=context)
    ...
    def write(self, cr, uid, ids, vals, context=None):
        super(dym_product_price_branch, self).write(cr, uid, ids, vals, context=context)
        if vals.get('cost'):
...
class dym_product_price_history_branch(osv.osv):
    """
