...
class dym_stock_packing(report_sxw.rml_parse):
    ...
    def serial_number_ids(self):
        packing_id = self.pool.get('dym.stock.packing').browse(self.cr, self.uid, self.ids)
...
report_sxw.report_sxw('report.rml.print.surat.jalan', 'dym.stock.packing', 'addons/dym_stock/report/dym_print_serial_number.rml', parser = dym_stock_packing, header = False)
