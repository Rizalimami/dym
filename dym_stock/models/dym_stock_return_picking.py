...
class dym_stock_return_picking(osv.osv_memory):
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        if context is None:
            context = {}
        res = super(dym_stock_return_picking, self).default_get(cr, uid, fields, context=context)
...
class dym_stock_return_picking_line(osv.osv_memory):
