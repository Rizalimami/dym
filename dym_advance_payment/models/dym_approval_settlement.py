...
class dym_reason_reject_approval(models.TransientModel):
    _name = "dym.reason.reject.approval.stl"
    ...
    def dym_reject_approval(self, context=None):
        ...
        line = self.env['dym.settlement'].browse(po_id,context=context)
        objek = False
                    ...
                    if y == x.group_id :
                        ...
                        for z in line.approval_ids :
                            if z.reason == False :
                                ...
                                self.env['dym.settlement'].write( {'state':'draft','approval_state':'r'})
        if objek == False :
            raise Warning("User tidak termasuk group approval")
