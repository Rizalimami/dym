...
report_sxw.report_sxw('report.rml.settlement.done', 'dym.settlement', 'addons/dym_advance_payment/report/dym_settlement_done_report.rml', parser = dym_settlement, header = False)