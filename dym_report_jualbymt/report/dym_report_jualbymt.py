...
class dym_report_jualbymt_print(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        if context is None:
            context = {}
        super(dym_report_jualbymt_print, self).__init__(cr, uid, name, context=context)
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        order_by = " order by b.name asc, mt asc"

        self.cr.execute(query_jualbymt + query_where + order_by)
        ...
        super(dym_report_jualbymt_print, self).set_context(objects, data, ids, report_type)
    ...
    def formatLang_zero2blank(self, value, digits=None, date=False, date_time=False, grouping=True, monetary=False, dp=False, currency_obj=False):
        if isinstance(value, (float, int)) and not value:
            ...
            return super(dym_report_jualbymt_print, self).formatLang(value, digits, date, date_time, grouping, monetary, dp, currency_obj)

class wrapped_vat_declaration_print(orm.AbstractModel):
    _name = 'report.dym_report_jualbymt.report_jualbymt'
    _inherit = 'report.abstract_report'
    _template = 'dym_report_jualbymt.report_jualbymt'
    _wrapped_report_class = dym_report_jualbymt_print
