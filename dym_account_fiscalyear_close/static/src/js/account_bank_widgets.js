openerp.account = function (instance) {
    ...
    instance.web.views.add('tree_account_bank_reconciliation', 'instance.web.account.ReconciliationBankListView');
    instance.web.account.ReconciliationBankListView = instance.web.ListView.extend({
        init: function() {
        ...
        load_list: function() {
            ...
            if (this.partners) {
                this.$el.prepend(QWeb.render("AccountBankReconciliation", {widget: this}));
        ...
        do_search: function(domain, context, group_by) {
            ...
            return mod.call("list_journals_to_reconcile", [context, domain]).then(function(result) {
        ...
        search_by_partner: function() {
            ...
            var fct = function() {
                return self.old_search(new instance.web.CompoundDomain(self.last_domain, 
                    [["journal_id", "in", self.current_partner === null ? [] :
